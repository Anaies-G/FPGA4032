...
HD_PWD='C:/Users/Asus/Desktop/sems6/fpga/AnaiesGolboudaghians_EXS1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log evenodd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source evenodd.tcl
